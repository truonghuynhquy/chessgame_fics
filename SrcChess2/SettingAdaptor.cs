...
namespace SrcChess2 {
    ...
    internal class SettingAdaptor {
        ...
        public void LoadSearchMode(BoardEvaluationUtil boardEvalUtil, SettingSearchMode searchMode) {
            ...
            iTransTableSize = Settings.TransTableSize;
            if (iTransTableSize < 5) {
                iTransTableSize = 5;
            } else if (iTransTableSize > 1000) {
                iTransTableSize = 1000;
            }
            searchMode.TransTableEntryCount = iTransTableSize / 32 * 1000000;
        ...
        public void SaveSearchMode(SettingSearchMode searchMode) {
            ...
            m_settings.TransTableSize       = searchMode.TransTableEntryCount * 32 / 1000000;
