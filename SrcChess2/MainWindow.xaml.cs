...
namespace SrcChess2 {
    ...
    public partial class MainWindow : Window {
        ...
        private void ToggleDesignMode() {
            if (PlayingMode == PlayingModeE.DesignMode || MessageBox.Show(this, " Move list will be lost. Do you still want to switch to design mode?", "Design mode", MessageBoxButton.OKCancel) == MessageBoxResult.OK) {
