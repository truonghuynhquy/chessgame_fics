...
namespace SrcChess2 {
    ...
    public abstract class SearchEngine {
        ...
        public static bool IsSearchEngineBusy {
            get {
                return(s_searchEngineWorking != null);
            }
        }
        ...
        private void FindBestMove<T>(ChessBoard         board,
            ...
            moveList = board.EnumMoveList(ePlayer, bMoveList: true, out ChessBoard.PosInfoS posInfo);
            ...
            FindBestMove(board, searchMode, transTable, ePlayer, moveList, arrIndex, posInfo, ref move, out int iPermCount, out long _, out int iMaxDepth);
            moveExt                 = new MoveExt(move, "", iPermCount, iMaxDepth, iMaxDepth, 0);
            s_searchEngineWorking   = null;
            if (dispatcher != null) {
        ...
        public static bool FindBestMove<T>(ITrace               trace,
            ...
            if (IsSearchEngineBusy) { 
                ...
                bRetVal         = true;
                s_bCancelSearch = false;
                if ((searchMode.m_eOption & SearchMode.OptionE.UseTransTable) != 0) {
                    if (s_transTable == null || s_transTable.EntryCount != searchMode.m_iTransTableEntryCount) {
                        s_transTable = new TransTable(searchMode.m_iTransTableEntryCount);
                    } else {
                        s_transTable.Reset();
                    }
                ...
                s_searchEngineWorking = searchEngine;
                if (bMultipleThread) {
