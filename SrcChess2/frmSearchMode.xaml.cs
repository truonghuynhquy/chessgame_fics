...
namespace SrcChess2 {
    ...
    public partial class frmSearchMode : Window {
        ...
        private void textBoxTimeInSec_TextChanged(object sender, TextChangedEventArgs e) {
            butOk.IsEnabled = (Int32.TryParse(textBoxTimeInSec.Text, out int iVal) && iVal > 0 && iVal < 999);
        }
        ...
        private void textBoxTransSize_TextChanged(object sender, TextChangedEventArgs e) {
            butOk.IsEnabled = (Int32.TryParse(textBoxTransSize.Text, out int iVal) && iVal > 4 && iVal < 1000);
        }
        ...
        public void UpdateSearchMode() {
            ...
            m_settingSearchMode.TransTableEntryCount = iTransTableSize / 32 * 1000000;
